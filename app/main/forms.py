...
#    start_job = DateTimeField('Start at', id='datetimepicker1', format="%d-%m-%Y %H:%M")
...
class StartForm(FlaskForm):
    start_job = DateTimeField('', id='datetimepicker', format="%d-%m-%Y %H:%M")
    submit = SubmitField(_l('Старт'))
